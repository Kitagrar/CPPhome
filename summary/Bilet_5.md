...
+ Конструктор  
+ Деструктор  
+ Конструктор копирования: конструктор копирования используется для создания нового объекта, который является копией существующего. Он создается, когда объект присваивается новому объекту или передается в функцию по значению.  
+ Оператор присваивания: оператор присваивания используется для присваивания значений одного объекта другому объекту того же типа. Он создается, когда объект присваивается другому объекту с использованием оператора "=" или передается в функцию по значению  
+ Конструктор перемещения: конструктор перемещения используется для создания нового объекта путем перемещения ресурсов из существующего объекта, который больше не нужен. Он создается, когда временный объект передается в функцию или возвращается из функции.  
